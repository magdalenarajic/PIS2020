...
<!---Filmovi--->
    ...
    <div id="home-section-1" class="movie-show-container">
     <h3> Filmovi </h3>
        ...
        <div class="book-btn">
                                <a href="pregled.php" > Pogledaj više filmova</a>
                            </div>
    ...
    <div class="trailers-section">
        <br> <h3 class="section-title"> Istraži nove filmove </h3>
...
<div class="row">
            ...
            <form action="" method="POST">
                ...
                <button type="submit" name="submit1" value="submit">Pošalji</button>
                <?php
                 $link = mysqli_connect("localhost", "root", "", "baza");
